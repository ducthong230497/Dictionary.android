...
public class FloatingViewService extends Service {
    ...
    public void onCreate() {
        ...
        ImageView closeButtonCollapsed = (ImageView) mFloatingView.findViewById(R.id.btn_close);
        ...
        //Set the close button
        ImageView closeButton = (ImageView) mFloatingView.findViewById(R.id.btn_close);
